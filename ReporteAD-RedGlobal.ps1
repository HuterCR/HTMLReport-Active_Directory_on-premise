...
.PARAMETER CompanyLogo
    ...
    -CompanyLogo "https://hf-files-oregon.s3.amazonaws.com/hdpredglobalcr_user_customized/logo.png"

.PARAMETER RightLogo
    Enter URL or UNC path to your desired right-side logo for generated report.

    -RightLogo "https://img-prod-cms-rt-microsoft-com.akamaized.net/cms/api/am/imageFileData/RE1Mu3b?ver=5c31"
...
param (
	...
	[String]$CompanyLogo = "https://hf-files-oregon.s3.amazonaws.com/hdpredglobalcr_user_customized/logo.png",
	...
	[String]$RightLogo = "https://img-prod-cms-rt-microsoft-com.akamaized.net/cms/api/am/imageFileData/RE1Mu3b?ver=5c31",
